...
const SocialLinks = () => (
  <ul className="flex gap-4 mt-6">
    <li>
      <AppLink to="#">
        <Linkedin className="size-5 hover:scale-110" />
      </AppLink>
    </li>
    <li>
      <AppLink to="#">
        <Github className="size-5 hover:scale-110" />
      </AppLink>
    </li>
  </ul>
);
...
const Footer = () => {
  ...
  return (
    <footer className="bg-background text-primary py-25 px-35">
      ...
      <div className="mt-13 border-t border-primary pt-6 text-center text-sm capitalize">
