...
import { fetchBrandsOptions } from "../../search/hooks/brandCRUD";
...
const Products = () => {
  ...
  const [brandsQuery, newestProductQuery, topSellingProductsDataQuery] =
    useQueries({
      queries: [
        fetchBrandsOptions({ limit: 1000, selectField: "id, name, logo_url" }),
